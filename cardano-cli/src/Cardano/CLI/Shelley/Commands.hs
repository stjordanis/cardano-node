...
data AddressCmd
  = AddressKeyGen AddressKeyType OutputFormatOption VerificationKeyFile SigningKeyFile
...
data StakeAddressCmd
  = StakeAddressKeyGen OutputFormatOption VerificationKeyFile SigningKeyFile
...
data PoolCmd
  ...
  | PoolRetirementCert
      ...
      OutputFile
  | PoolGetId (VerificationKeyOrFile StakePoolKey) OutputFormatOption OutputDirection
...
-- | Output format option for CLI parsing.
data OutputFormatOption
  = OutputFormatOptionBech32
  | OutputFormatOptionHex
  | OutputFormatOptionTextEnvelope
  deriving (Eq, Show)
